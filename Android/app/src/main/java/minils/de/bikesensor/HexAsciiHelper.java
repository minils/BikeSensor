/**
 * Taken from https://github.com/lann/RFDuinoTest/tree/master/src/main/java/com/lannbox/rfduinotest
 */
...
public class HexAsciiHelper {
    ...
    public static String getTemperatureString(byte[] bytes) {
        int temp = byteArrayToInt(bytes);
        String big = String.valueOf(temp / 10);
        String small = String.valueOf(temp % 10);
        return big+"."+small+" °C";
    }
